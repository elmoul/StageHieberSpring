...
public class UserController {
	...
	public String pageIndex2(Model model) {
		...
		// changes made by mouloud
		System.out.println("Hello am mouloud");
	...
	public String ajoutUser(Model model,@RequestParam String nom
	...
	public String resirect(Model model,@RequestParam String page) {
		switch(page) {
			case "addUser": 	goToAddUser(model);
								return "addUser";
								
			case "allUsers":	model.addAttribute("listUsers", service.getAllUsers());
								model.addAttribute("page", "users");
								return "Users";
								
			case "addProfile":	model.addAttribute("page", "addProfile");
								return "addProfile";
								
			case "allProfiles":	model.addAttribute("listProfiles", profileService.getAllProfiles());
								model.addAttribute("page", "profiles");
								return "profiles";
								
			default :return "pageVide";
		}
